...
public class JavaLexer extends gbmvdd.bse.BSELexer implements JavaTokenTypes, TokenStream
 {

	public int k() { return 4; }
...
public JavaLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("protected", this), new Integer(59));
	literals.put(new ANTLRHashString("native", this), new Integer(62));
	literals.put(new ANTLRHashString("true", this), new Integer(132));
	literals.put(new ANTLRHashString("long", this), new Integer(52));
	literals.put(new ANTLRHashString("byte", this), new Integer(47));
	literals.put(new ANTLRHashString("break", this), new Integer(85));
	literals.put(new ANTLRHashString("new", this), new Integer(135));
	literals.put(new ANTLRHashString("float", this), new Integer(51));
	literals.put(new ANTLRHashString("volatile", this), new Integer(65));
	literals.put(new ANTLRHashString("import", this), new Integer(30));
	literals.put(new ANTLRHashString("private", this), new Integer(57));
	literals.put(new ANTLRHashString("this", this), new Integer(130));
	literals.put(new ANTLRHashString("final", this), new Integer(39));
	literals.put(new ANTLRHashString("short", this), new Integer(49));
	literals.put(new ANTLRHashString("while", this), new Integer(83));
	literals.put(new ANTLRHashString("implements", this), new Integer(72));
	literals.put(new ANTLRHashString("extends", this), new Integer(67));
	...
	literals.put(new ANTLRHashString("synchronized", this), new Integer(64));
	...
	literals.put(new ANTLRHashString("double", this), new Integer(53));
	literals.put(new ANTLRHashString("case", this), new Integer(90));
	literals.put(new ANTLRHashString("void", this), new Integer(45));
	literals.put(new ANTLRHashString("false", this), new Integer(133));
	literals.put(new ANTLRHashString("class", this), new Integer(66));
	literals.put(new ANTLRHashString("static", this), new Integer(60));
	literals.put(new ANTLRHashString("boolean", this), new Integer(46));
	...
	literals.put(new ANTLRHashString("package", this), new Integer(16));
	literals.put(new ANTLRHashString("transient", this), new Integer(61));
	literals.put(new ANTLRHashString("catch", this), new Integer(94));
	literals.put(new ANTLRHashString("default", this), new Integer(91));
	literals.put(new ANTLRHashString("public", this), new Integer(58));
	literals.put(new ANTLRHashString("throws", this), new Integer(78));
	literals.put(new ANTLRHashString("interface", this), new Integer(68));
	literals.put(new ANTLRHashString("int", this), new Integer(50));
	literals.put(new ANTLRHashString("threadsafe", this), new Integer(63));
	...
	for (;;) {
		...
		try {   // for char stream error handling
			try {   // for lexical error handling
				...
				else { consume(); throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine()); }
				}
				}
				...
				_returnToken = makeToken( Token.INVALID_TYPE );
				_returnToken.setText( new String( text.getBuffer(), 0, text.length() ) );
				return _returnToken;
			}
		}
		...
		case 'u':
		{
			...
			do {
				if ((LA(1)=='u')) {
					...
					if ( _cnt246>=1 ) { break _loop246; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine());}
				}
				...
				case 'X':  case 'x':
				{
					...
					do {
						if ((_tokenSet_5.member(LA(1))) && (true) && (true) && (true)) {
							...
							if ( _cnt271>=1 ) { break _loop271; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine());}
						}
				...
				case '4':  case '5':  case '6':  case '7':
				{
					...
					do {
						if (((LA(1) >= '0' && LA(1) <= '7'))) {
							...
							if ( _cnt273>=1 ) { break _loop273; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine());}
						}
	...
	protected final void mEXPONENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if (((LA(1) >= '0' && LA(1) <= '9'))) {
				...
				if ( _cnt289>=1 ) { break _loop289; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine());}
			}
