...
public interface JavaTokenTypes {
	...
	int LITERAL_byte = 47;
	int LITERAL_char = 48;
	int LITERAL_short = 49;
	int LITERAL_int = 50;
	int LITERAL_float = 51;
	int LITERAL_long = 52;
	int LITERAL_double = 53;
	int IDENT = 54;
	int DOT = 55;
	int STAR = 56;
	int LITERAL_private = 57;
	int LITERAL_public = 58;
	int LITERAL_protected = 59;
	int LITERAL_static = 60;
	int LITERAL_transient = 61;
	int LITERAL_native = 62;
	int LITERAL_threadsafe = 63;
	int LITERAL_synchronized = 64;
	int LITERAL_volatile = 65;
	int LITERAL_class = 66;
	int LITERAL_extends = 67;
	int LITERAL_interface = 68;
	int LCURLY = 69;
	int RCURLY = 70;
	int COMMA = 71;
	int LITERAL_implements = 72;
	int LPAREN = 73;
	int RPAREN = 74;
	int LBRACK = 75;
	int RBRACK = 76;
